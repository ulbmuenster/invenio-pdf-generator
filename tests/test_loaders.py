...
from invenio_pdf_generator.backends.utils.loaders import (
    datetime_delta,
    datetime_format,
    unit_calculator,
)
...
def test_unit_calculator():
    ...
    assert unit_calculator(1012) == "1 KB"
    assert unit_calculator(5321003) == "5 MB"
    assert unit_calculator(5321003000) == "5 GB"
    assert unit_calculator(7321003000000) == "7 TB"
    assert unit_calculator(9300865421003000) == "9 PB"
    assert unit_calculator(11321003000000000000) == "11 EB"
    assert unit_calculator(501321003000000000000000) == "501 ZB"
